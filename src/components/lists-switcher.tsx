...
/** Collections and decks are both lists of cards: one tab each, above either page. */
      ...
      {TABS.map((t) => (
        <Link
          ...
          className={cn(
            ...
            current === t.key ? "bg-background font-medium shadow-sm" : "text-muted-foreground hover:text-foreground",
          )}
        >
          {t.label}
        </Link>
